...
class UploadTo:
    ''' UploadTo
        UploadTo('folder_name', [plus_id=True]): To automate upload_to callable function for file uploading path
    '''
    ...
    #     ValueError: Cannot serialize: <accounts.helpers.UploadTo object at 0x0000022264685C88>
